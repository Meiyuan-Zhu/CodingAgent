...
- 日期：2026-09-02（北京时间）。
- 范围：`frontend/src/components/MarkdownBlock.vue`、`frontend/src/components/ProjectSidebar.vue`、`frontend/src/style.css`、`DESIGN.md`。
- 实现检查：
  ...
  - 右侧 Inspector header 主标题使用当前 project 名称，未加载项目时才兜底为 `Workspace`。
